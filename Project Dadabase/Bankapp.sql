...
CREATE PROCEDURE insert_appointment(IN username VARCHAR(12),IN city VARCHAR(12),IN bank VARCHAR(20),IN location VARCHAR(100),IN day_ VARCHAR(12),IN  hour_ VARCHAR(12),IN type_ VARCHAR(30),IN note TEXT )
BEGIN
